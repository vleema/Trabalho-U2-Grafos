...
A cada passo do iterador, ele calcula qual é o nó disponível com menor distância, adiciona-o no conjunto dos visitados e realiza o relaxamento de seus vizinhos e retorna o novo vértice do caminho mais curto junto de sua distância. Caso não haja mais nós disponíveis no início do algoritmo, o iterador retorna `None`, um vazio.

Os consumidores deste iterador serão capazes de montar o caminho mais curto a partir dos campos atualizados do iterador.
