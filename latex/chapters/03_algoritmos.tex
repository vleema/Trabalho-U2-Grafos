...
dos problemas de caminho mínimo, e diferente de \ref{sec:pseudocode_dijkstra}, não
se trata de um algoritmo guloso. Além de ter a capacidade de lidar com arestas de
...
triangular para verificar se, dada uma aresta que liga os vértices A e B, é possível
obter um custo menor de A para B percorrendo um terceiro vértice. E por fim, uma
vez realizado o relaxamento de arestas, a desigualdade triangular será verificada
...
Note que este se trata de um algoritmo de complexidade $O(nm)$ em essência. Entretanto,
